...
Développement d’un classifieur multimodal de biens de consommation exploitant leurs descriptions (NLP) et leurs images (Vision par Ordinateur). Après validation de l'approche par des modèles Deep Learning (BERT pour le texte, CNN pour les images), un classifieur final (CNN) a été construit, atteignant une **accuracy de 81.3%**.
